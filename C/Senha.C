...
/*screva um programa para cadastro de usuário, com uma struct armazenando
usuário e senha. Haverá quatro opções
1. Novo usuário, cadastrarusuário com nome de usuário,senha e confirmarsenha.
2. Remover usuário:remover usuário baseado no seu nome.
3. Acessar o sistema. O usuario deve adicionar nome e senha. Se ok, libear acesso,
senão, negar acesso
4. Sair do programa.*/
